...
/// <summary>
/// Spécification représentant l'opérateur logique OR entre deux spécifications.
/// Conforme à ADR-028 (Specification Pattern).
/// </summary>
/// <typeparam name="T">Type d'entité.</typeparam>
/// <remarks>
/// Combine deux spécifications : l'entité doit satisfaire left OU right.
/// </remarks>
internal sealed class OrSpecification<T> : CompositeSpecification<T>
{
    ...
    /// <summary>
    /// Initialise une nouvelle instance de <see cref="OrSpecification{T}"/>.
    /// </summary>
    ...
    /// <summary>
    /// Vérifie si l'entité satisfait au moins une des deux spécifications.
    /// </summary>
    /// <param name="entity">Entité à tester.</param>
    /// <returns><c>true</c> si satisfait au moins une, sinon <c>false</c>.</returns>
    ...
    /// <summary>
    /// Convertit en expression LINQ combinant les deux spécifications avec OR.
    /// </summary>
    /// <returns>Expression (left OR right).</returns>
